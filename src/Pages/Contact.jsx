    ...
    <div className='bg-gray-100 '>
      <div className="min-h-screen max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2  items-center justify-center p-4 mt-16 md:mt-0">
        <div className="bg-white shadow-lg rounded-lg p-6 w-full max-w-md mb-6">
          <h2 className="text-2xl font-bold text-center text-green-600">Contact DailyCart</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">info@dailycart.com</p>
                <p className="text-gray-600">orders@dailycart.com</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">123, XYZ Street </p>
                <p className="text-gray-600">ABC City, PC 12345</p>
              </div>
            </div>
