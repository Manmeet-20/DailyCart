...
import DailyCart from "../assets/DailyCart.jpg"
    ...
    <div className="bg-gray-100">
      <div className="max-w-6xl mx-auto py-12 px-4 mt-16">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold mb-4 text-green-700">About DailyCart</h1>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center md:mb-20">
          <div>
            ...
            <div className="space-y-4 text-gray-600">
              <p>
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Libero sapiente perferendis velit exercitationem est quaerat earum aliquid itaque eum numquam, recusandae modi eaque ullam harum, totam adipisci facere quibusdam quia?
              </p>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores, veniam laborum. Aspernatur quis laborum sint beatae velit eius incidunt officia consequatur nobis nostrum? Magnam unde alias cupiditate accusantium a dolore eligendi earum aperiam ipsam illum voluptatem perspiciatis dicta debitis dignissimos exercitationem repellendus iusto fugiat, eaque doloremque maxime tempora in modi!
              </p>
              <p>
        ...
        <div className="bg-green-50 p-8 rounded-lg">
          <h2 className="text-2xl font-semibold mb-4 text-green-600 text-center">Join the DailyCart Family</h2>
