  ...
  return (
    <div>
      <div className='mx-auto flex justify-between items-center px-6 py-3 fixed top-0 z-20 bg-green-100 w-full border border-gray-100 shadow-xl lg:px-[180px]'>
           {/* logo section */}
              <Link to={'/'}>
                  <h1 className='text-2xl text-green-700 font-bold'>Daily<span className='text-orange-600'>Cart</span></h1>
              </Link>
           {/* menu section */}
           <nav className='flex gap-5'>
            <ul className='text-xl font-semibold md:flex items-center gap-7 hidden'>
                ...
                <Link to={'/shop'}><li className='hover:text-green-700'>Shop</li></Link>
                <Link to={'/about'}><li className='hover:text-green-700'>About</li></Link>
                <Link to={'/contact'}><li className='hover:text-green-700'>Contact</li></Link>
            </ul>
