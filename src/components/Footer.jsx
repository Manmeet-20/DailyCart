    ...
    <footer className='bg-gray-800 text-white py-12 px-4 md:px-0'>
      <div className='max-w-6xl mx-auto'>
        <div className='grid grid-cols-1 md:grid-cols-3 gap-50'>
            <div>
                <h3 className='text-xl font-bold mb-4'>DailyCart</h3>
            ...
            <div>
                ...
                <p className='mb-2'>123, XYZ Street, ABC City</p>
                <p className='mb-2'>Phone: (123) 456-7890</p>
                <p className='mb-2'>Email: info@dailycart.com</p>
            </div>
        </div>
        <div className='mt-8 pt-8 border-t border-gray-700 text-center'>
            <p>&copy; {new Date().getFullYear()} DailyCart</p>
        </div>
      </div>
    </footer>
  )
